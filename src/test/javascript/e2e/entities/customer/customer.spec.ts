...
describe('Customer e2e test', () => {
  ...
  it('should create and save Customers', async () => {
    async function createCustomer() {
      ...
      await customerUpdatePage.setTelephoneInput('telephone');
  ...
  it('should delete last Customer', async () => {
    ...
    expect(await customerDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/ecommerceApp.customer.delete.question/);
